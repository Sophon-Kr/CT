<template>
  <div>
    ...
    <nav
      ...
      style="background-color: #87c589; font-family: Comic Sans MS"
    >
      <router-link to="/users" class="text-decoration-none">
        ...
        >
          <img
            src="./assets/icons8-cactus-in-pot-48.png"
            alt=""
            width="35"
            height="35"
            class="d-inline-block align-text-top"
          />
          <span class="fs-4" style="font-family: Comic Sans MS; color: #ffffff">
            &nbsp;&nbsp;MYCACTI&nbsp;&nbsp;</span
          >
        </a>
      </router-link>
